...
*** UPDATE ***
THIS IS CODE CHALLENGE EXCERCISE!  I will introduce a new variable called BeatLengthMultiplier. This variable will be used to alter the duration of the tones while they're being played.
...
void play( char note, int beats)
{
  ...
  int beatLength = 150 * beatLengthMultiplier;   //the length of one beat (changing this will speed up or slow down the tempo of the song) ** HACK: Alter beat length
