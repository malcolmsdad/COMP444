/*
  ...
  ** HACK:  Coding Challenge has this code modified to increase difficulty and modify the tones
*/
...
// CHEATER MODE: Show the sequence to the player
...
// }
  ...
  if (gameStarted == true) {
    ...
    if (roundCounter >= gameSize()) {              //if the player has gotten to the 16th round
...
void startSequence() {
  ...
  for (int i = 0; i < gameSize(); i++) {
    // digitalWrite(led[0], HIGH);            // DEBUG CODE!! LED ON: Flash the LED to represent the number of rounds! 
    buttonSequence[i] = round(random(0, 4));
    //delay(500);                               // DEBUG CODE!! Delay 1/2 second: Flash the LED to represent the number of rounds!
    //digitalWrite(led[0], LOW);                // DEBUG CODE!! LED OFF: Flash the LED to represent the number of rounds!
    //delay(500);                               // DEBUG CODE!! Delay 1/2 second: Flash the LED to represent the number of rounds!
  }
...
void winSequence() {
  ...
  // winMusic();    // this sounds normal
  winMusicRandom(); // this does not.
