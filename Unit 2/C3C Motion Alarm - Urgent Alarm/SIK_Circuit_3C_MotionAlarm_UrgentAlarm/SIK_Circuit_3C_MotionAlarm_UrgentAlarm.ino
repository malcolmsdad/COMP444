...
void loop() {
  ...
  if (distance <= close) {                       //if the object is close
    ...
    delay(10 * distance);         //wait 10 * distance milliseconds, this makes it sound more urgent


  } else if (close < distance && distance < far) { //if the object is a medium distance
